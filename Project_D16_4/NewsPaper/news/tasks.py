...
def hello():
    time.sleep(10)
    print("Hello, world! Test letter!")
    # тестовая рассылка для проверки работоспособности сервиса

# рассылка о создании нового поста
@shared_task
...
# еженедельная рассылка о новых сообщениях в выбранной категории
@shared_task
