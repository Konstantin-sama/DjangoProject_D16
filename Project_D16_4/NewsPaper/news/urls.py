...
from .views import AuthorDetail, AuthorList, CategoryList, PostList, PostDetail, PostCreate, PostDelete, PostEdit, \
    PostSearch, PostsOfCategoryList, subscribe, IndexView
